...
<head>
	...
	<title>CRM</title>
		...
		<?php echo link_tag('jquery-ui-1.10.0.custom/js/dist/jquery.jqplot.min.css');?>
		<?php echo link_tag('style/jquery-ui.css');?>
		<!--?php echo link_tag('style/estilo.css');?-->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>jquery-ui-1.10.0.custom/js/jquery-ui-1.10.0.custom.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>jquery-ui-1.10.0.custom/js/jquery-ui-1.10.0.custom.min.js"></script>
