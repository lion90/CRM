...
<li>
		...
		<ul >
			...
			<li><a class="s" href="#"><img src="<?php echo base_url(); ?>style/imagenes/informe.png" border="0" style="width:19px;height:19px;float: left; padding-left: 10px;">Open House</a></li>
